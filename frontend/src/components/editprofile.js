...
const EditProfile = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            if (email) {
                ...
                setProfilePreview(`http://18.212.250.251:5000/${userData.profilePicture}`);
            }
        };
        fetchUserData();
    }, [email]);
    ...
    const handleCancelClick = () => {
        setIsEditing(false);
        setProfilePreview(`http://18.212.250.251:5000/${user.profilePicture}`);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        setProfilePreview(`http://18.212.250.251:5000/${updatedUserData.profilePicture}`);
    };
